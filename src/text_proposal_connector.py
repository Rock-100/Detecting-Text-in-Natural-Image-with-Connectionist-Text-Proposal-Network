...
class TextProposalConnector:
    ...
    def get_text_lines(self, text_proposals, scores, im_size, sides):
        ...
        for index, tp_indices in enumerate(tp_groups):
            ...
            x0 = line_side[x0_index] * cfg.TEXT_PROPOSALS_WIDTH + (text_line_boxes[x0_index][0] + text_line_boxes[x0_index][2]) / 2.0
            x1 = line_side[x1_index] * cfg.TEXT_PROPOSALS_WIDTH + (text_line_boxes[x1_index][0] + text_line_boxes[x1_index][2]) / 2.0
